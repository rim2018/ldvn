...
public class LdvnTestContainer extends TestContainer {

    public LdvnTestContainer() {
        super();
    ...
    public static class Common extends LdvnTestContainer {

        public static final LdvnTestContainer.Common INSTANCE = new LdvnTestContainer.Common();
